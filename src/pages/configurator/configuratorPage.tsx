...
import placeholderImage from './assets/placeholder/configurator.png'; // Import placeholder image
    ...
    <div className="space-y-8">
      ...
      {materials.length === 0 ? (
        <div className="flex justify-center">
          <img src={placeholderImage} alt="Configurator Placeholder" className="w-full h-auto cursor-pointer" />
        </div>
      ) : (
        <ConfiguratorList materials={materials} />
      )}
    </div>
  );
}